...
9. In the Select a bucket or directory window, choose the required container (e.g., fabriciqlabdata) and verify that all CSV files are visible.Click on **Next** to proceed.
 
    ![fabriclabdata](../media/fabriclabdata.png)
